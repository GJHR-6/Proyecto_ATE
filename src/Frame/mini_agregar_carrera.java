...
public class mini_agregar_carrera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Escriba el nombre de la carrera");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mini_agregar_carrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mini_agregar_carrera().setVisible(true);
            }
        });
    }
